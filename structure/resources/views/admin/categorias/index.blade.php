      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <button class="btn btn-warning pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar categoría</button>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin.categorias.edit', $categoria )}}" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    ...
                    <form method="POST"
                      ...
                      <button class="btn btn-sm btn-danger"
                        onclick="return confirm('Estás seguro de querer eliminar la categoría?')"
      ...
      <div class="modal-dialog">
        <div class="modal-content bg-secondary">
          <div class="modal-header">
            <h4 class="modal-title" id="myModal">Agrega el nombre de la categoría</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}" >
              <input class="form-control" name="name" value="{{old('name')}}" placeholder="Ingresa aquí el nombre de la categoría" required>
