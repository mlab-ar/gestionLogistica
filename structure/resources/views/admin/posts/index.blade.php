      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <button class="btn btn-warning pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Agregar post</button>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <span class="badge badge-primary" style="background-color:{{$post->evento->color}};font-size:13px">{{$post->evento->nombre_destacado}}</span></td>
                  ...
                  @endif
                  <td>
                    <a href="{{ route('admin.posts.edit', $post )}}" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    ...
                    <form method="POST"
                      ...
                      <button class="btn btn-sm btn-danger"
                        onclick="return confirm('Estás seguro de querer eliminar el post?')"
      ...
      <div class="modal-dialog">
        <div class="modal-content bg-secondary">
          <div class="modal-header">
            <h4 class="modal-title" id="myModal">Agrega el título del post</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}" >
              <input class="form-control" name="title" value="{{old('title')}}" placeholder="Ingresa aquí el título del post" required>
