      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.subcategorias.index')}}">Sub Categorías</a></li>
      ...
      <div class="col-md-6">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">EDITAR SUBCATEGORÍA</h3>
          </div>

          <form class="form-horizontal"  method="POST" action="{{route('admin.subcategorias.update', $categorias)}} ">
              ...
              <div class="form-group">
                ...
                <div class="form-group col-md-6">
                    <label>SUBCATEGORÍA ACTIVA</label>
                      ...
                      <option value="SI" {{ old('activo',$categorias->activo) == 'SI' ? 'selected' : ''}}>SI</option>
                      <option value="NO" {{ old('activo',$categorias->activo) == 'NO' ? 'selected' : ''}}>NO</option>
                    </select>
                </div>

                <div class="form-group col-md-6">
                    <label>SUBCATEGORÍA DESTACADA</label>
