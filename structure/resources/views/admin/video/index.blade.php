...
@section('content')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Video Institucional del Evento</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
            <li class="breadcrumb-item active">Video Institucional</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  <td> {{$video->link}} </td>
                  <td> <span class="badge badge-primary" style="background-color:{{$video->evento->color}};font-size:13px">{{$video->evento->nombre_destacado}}</span></td>
                  <td>
                    <a href="{{ route('admin.video.edit', $video )}}" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                    <form method="POST"
      ...
      <div class="modal-dialog">
        <div class="modal-content bg-secondary">
          <div class="modal-header">
            <h4 class="modal-title" id="myModal">Indica el link de YouTube para el video</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="form-group {{ $errors->has('link') ? 'has-error' : ''}}" >
              <input class="form-control" name="link" value="{{old('link')}}" placeholder="Link YouTube" required>
