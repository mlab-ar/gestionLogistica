...
<head>
    ...
    <title>CrediHub - The best content in the credit industry</title>
    ...
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
        ...
        <div class="off-canvas position-left light-off-menu" id="offCanvas-responsive" data-off-canvas>
            ...
            <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
              <li><a href="/en"><img src="/lay-web/images/idioma/nuevo/icono-home.png" alt="CredhiHub 2019" style="width:17px">home</a></li>
              <li class="has-submenu" data-dropdown-menu="example1">
                  <a href="#"><img src="/lay-web/images/idioma/nuevo/icono-videos.png" alt="CredhiHub 2019" style="width:17px">Videos</a>
                  <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                    @foreach(App\Pais::orderBy('nombre')->get() as $pais)
                      @if($pais->id != 0)
                        <li><a href="/en/listado-videos-pais/{{$pais->id}}">{{$pais->nombre_us}}</a></li>
                      @endif
                    @endforeach
                    <li align="center"><a href="/en/todos-los-videos">ALL</a></li>
                  </ul>
              </li>
              <li class="has-submenu" data-dropdown-menu="example1">
                  <a href="#"><img src="/lay-web/images/idioma/nuevo/icono-user.png" alt="CredhiHub 2019" style="width:17px">CATEGORIES</a>
                  <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                      @foreach(App\Category::where('destacado','=','SI')->orderBy('name')->get() as $cat)
                        <li><a href="/en/listado-videos/{{$cat->id}}">{{$cat->name_us}}</a></li>
                      @endforeach
                  </ul>
              </li>
                <li class="has-submenu" data-dropdown-menu="example1">
                    ...
                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                        ...
                        @if(auth()->user()->role->name === 'admin')
                          <li><a href="/admin/dashboard" target="_blank" >ADMIN PANEL</a></li>
                        @endif
                        <li>
                ...
                <li class="has-submenu" data-dropdown-menu="example1">
                    <a href="#"><img src="/lay-web/images/idioma/nuevo/icono-idioma.png" alt="CredhiHub 2019" style="width:17px" title="IDIOMA">LANGUAGE</a>
                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                                ...
                                <div class="large-12 columns">
                                    ...
                                    <div class="top-bar show-for-large" id="beNav" style="width: 100%;">
                                        <div class="top-bar-left">
                                            <ul class="menu">
                                                <li class="menu-text">
                                                    <a href="/en"><img src="/lay-front/img/logo.png" alt="CredhiHub 2019 LOGO" style="width:180px"></a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="menu vertical medium-horizontal" data-responsive-menu="drilldown medium-dropdown">
                                                ...
                                                <li class="has-submenu" data-dropdown-menu="example1">
                                                    ...
                                                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                                                      @foreach(App\Pais::orderBy('nombre')->get() as $pais)
                                                        @if($pais->id != 0)
                                                          <li><a href="/en/listado-videos-pais/{{$pais->id}}"></i>{{$pais->nombre_us}}</a></li>
                                                        @endif
                                                      @endforeach
                                                      <li align="center"><a href="/en/todos-los-videos"></i>ALL</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-submenu" data-dropdown-menu="example1">
                                                    <a href="#"><img src="/lay-web/images/idioma/nuevo/icono-cat.png" alt="CredhiHub 2019" style="width:17px">CATEGORIES</a>
                                                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                                                        @foreach(App\Category::where('destacado','=','SI')->orderBy('name')->get() as $cat)
                                                          <li><a href="/en/listado-videos/{{$cat->id}}"></i>{{$cat->name_us}}</a></li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="has-submenu" data-dropdown-menu="example1">
                                                    <a href="#"><img src="/lay-web/images/idioma/nuevo/icono-idioma.png" alt="CredhiHub 2019" style="width:17px" title="LANGUAGE"></a>
                                                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
