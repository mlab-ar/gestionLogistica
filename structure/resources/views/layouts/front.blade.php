    ...
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
        ...
        <div class="off-canvas position-left light-off-menu" id="offCanvas-responsive" data-off-canvas>
            ...
            <ul class="vertical menu off-menu" data-responsive-menu="drilldown">
              <li><a href="/inicio"><img src="/lay-web/images/idioma/nuevo/icono-home.png" alt="CredhiHub 2019" style="width:17px">home</a></li>
              <li class="has-submenu" data-dropdown-menu="example1">
                  ...
                  <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                    @foreach(App\Pais::orderBy('nombre')->get() as $pais)
                      @if($pais->id != 0)
                        <li><a href="/listado-videos-pais/{{$pais->id}}">{{$pais->nombre}}</a></li>
                      @endif
                    @endforeach
                    <li align="center"><a href="/todos-los-videos">TODOS</a></li>
                  </ul>
              </li>
              <li class="has-submenu" data-dropdown-menu="example1">
                  <a href="#"><img src="/lay-web/images/idioma/nuevo/icono-user.png" alt="CredhiHub 2019" style="width:17px">CATEGORÍAS</a>
                  <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                      @foreach(App\Category::where('destacado','=','SI')->orderBy('name')->get() as $cat)
                        <li><a href="/listado-videos/{{$cat->id}}">{{$cat->name}}</a></li>
                      @endforeach
                  </ul>
              </li>
                <li class="has-submenu" data-dropdown-menu="example1">
                                ...
                                <div class="large-12 columns">
                                    ...
                                    <div class="top-bar show-for-large" id="beNav" style="width: 100%;">
                                        <div class="top-bar-left">
                                            <ul class="menu">
                                                <li class="menu-text">
                                                    <a href="/inicio"><img src="/lay-front/img/logo.png" alt="CredhiHub 2019 LOGO" style="width:180px"></a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="menu vertical medium-horizontal" data-responsive-menu="drilldown medium-dropdown">
                                                ...
                                                <li class="has-submenu" data-dropdown-menu="example1">
                                                    ...
                                                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                                                      @foreach(App\Pais::orderBy('nombre')->get() as $pais)
                                                        @if($pais->id != 0)
                                                          <li><a href="/listado-videos-pais/{{$pais->id}}"></i>{{$pais->nombre}}</a></li>
                                                        @endif
                                                      @endforeach
                                                      <li align="center"><a href="/todos-los-videos"></i>TODOS</a></li>
                                                    </ul>
                                                </li>
                                                <li class="has-submenu" data-dropdown-menu="example1">
                                                    <a href="#"><img src="/lay-web/images/idioma/nuevo/icono-cat.png" alt="CredhiHub 2019" style="width:17px">CATEGORÍAS</a>
                                                    <ul class="submenu menu vertical" data-submenu data-animate="slide-in-down slide-out-up">
                                                        @foreach(App\Category::where('destacado','=','SI')->orderBy('name')->get() as $cat)
                                                          <li><a href="/listado-videos/{{$cat->id}}"></i>{{$cat->name}}</a></li>
                                                        @endforeach
                                                    </ul>
                                                </li>
