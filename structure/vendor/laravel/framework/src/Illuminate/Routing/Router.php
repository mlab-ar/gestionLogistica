...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth(array $options = [])
    {
        ...
        $this->get('ingreso-en-plataforma', 'Auth\LoginController@showLoginForm')->name('login');
        $this->post('ingreso-en-plataforma', 'Auth\LoginController@login');
        $this->post('logout', 'Auth\LoginController@logout')->name('logout');

        // Registration Routes...
        if ($options['register'] ?? true) {
            $this->get('registro-en-plataforma', 'Auth\RegisterController@showRegistrationForm')->name('register');
            $this->post('registro-en-plataforma', 'Auth\RegisterController@register');
        }
